                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a id="normalorders" class="nav-link" href="#">Grocery Orders</a></li>
                                <li><a id="mediaorders" class="nav-link" href="#">Restaurant Orders</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a id="productdetails" class="nav-link has-dropdown" href="#"><i class="fas fa-shopping-basket"></i> <span>Product Details</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a id="categories" class="nav-link" href="#">Grocery Categories</a></li>
                        ...
                        <li class="nav-item">
                            <a id="help" class="nav-link" href="javascript:void(0);"><i class="fas fa-question-circle"></i></i><span>Help & Support</span></a>
                        </li>
                    </ul>
                </aside>
            </div>
